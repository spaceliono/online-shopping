...
<?php include('../api/indexApi.php');?>
	...
	<section>
			<div id="logi">
				...
				<div id="login-box">
					<form action="../api/userLoginApi.php" method="post">
					<ul>
						<li><input type="" name="name" id="img-01" class="defi-input" placeholder="请输入用户名"></li>
						<li><input type="password" name="pwd" id="img-02" class="defi-input" placeholder="请输入密码"></li>
						<li><input type="submit" name="" id="img-06" class="defi-input" value="立即登录"></li>
						<li id="regist_foget">
							<a href="register.v.html">注册账号</a>|
							<a href="foud_pwd.v.html">忘记密码？</a>
						</li>
					</ul> 
				</form>
			    </div>
